...
for (let i = 0                 ; i <= 10  ; i++)
inicialização da variável --> aqui colocamos um valor inicial para a variável que servirá para controle de nosso laço. Normalmente o nome dessa variável é i(increment) porém não há problemas em usar outro nome
...
incremento --> aumento no número da variável. i++ é a mesma coisa que i = i + 1
*/